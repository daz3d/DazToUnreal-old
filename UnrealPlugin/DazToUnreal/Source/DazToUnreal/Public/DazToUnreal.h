...
public:
	...
	/** Functio to start the import process*/
	UObject* ImportFromDaz(const FString& FBXPath, const FString& AssetName, const DazAssetType& AssetType, const FString& ImportFolder);
