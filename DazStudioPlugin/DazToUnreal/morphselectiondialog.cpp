...
MorphSelectionDialog* MorphSelectionDialog::singleton = nullptr;
...
MorphSelectionDialog::MorphSelectionDialog(QWidget *parent) :
...
QSize MorphSelectionDialog::minimumSizeHint() const
{
	return QSize(800, 800);
}

// Build out the Left morphs tree based on the current selection
void MorphSelectionDialog::PrepareDialog()
{
...
void MorphSelectionDialog::FilterChanged(const QString& filter)
{
...
QStringList MorphSelectionDialog::GetAvailableMorphs(DzNode* Node)
{
...
void MorphSelectionDialog::UpdateMorphsTree()
{
...
QTreeWidgetItem* MorphSelectionDialog::FindTreeItem(QTreeWidgetItem* parent, QString name)
{
	if (parent == nullptr)
	{
...
void MorphSelectionDialog::ItemSelectionChanged()
{
...
void MorphSelectionDialog::SelectMorphsInNode(QTreeWidgetItem* item)
{
...
void MorphSelectionDialog::HandleAddMorphsButton()
{
...
void MorphSelectionDialog::HandleRemoveMorphsButton()
{
...
void MorphSelectionDialog::HandleSavePreset()
{
...
void MorphSelectionDialog::SavePresetFile(QString filePath)
{
	QDir dir;
	dir.mkpath(presetsFolder);
	if (filePath == NULL)
...
void MorphSelectionDialog::HandleArmJCMMorphsButton()
{
...
// Hard coded list of morphs for Genesis 3 and 8
// It just adds them all, the other functions will ignore any that don't fit the character
void MorphSelectionDialog::HandleLegJCMMorphsButton()
{
	QStringList MorphsToAdd;
...
// Hard coded list of morphs for Genesis 3 and 8
// It just adds them all, the other functions will ignore any that don't fit the character
void MorphSelectionDialog::HandleTorsoJCMMorphsButton()
{
	QStringList MorphsToAdd;
...
void MorphSelectionDialog::RefreshExportMorphList()
{
...
void MorphSelectionDialog::RefreshPresetsCombo()
{
...
void MorphSelectionDialog::HandlePresetChanged(const QString& presetName)
{
...
QString MorphSelectionDialog::GetMorphString()
{
...
QString MorphSelectionDialog::GetMorphCSVString()
{
	morphList.clear();
	QString morphString;
	foreach(MorphInfo exportMorph, morphsToExport)
...
QString MorphSelectionDialog::GetMorphRenaming()
{
	...
	QString morphString;
	for (QString morph : morphList)
	{
		morphString.append(morph + "=" + morphNameMapping[morph] + "\n");
	}
	return morphString;
}