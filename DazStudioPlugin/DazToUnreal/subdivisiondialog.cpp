...
SubdivisionDialog* SubdivisionDialog::singleton = nullptr;
...
QSize SubdivisionDialog::minimumSizeHint() const
{
	return QSize(800, 800);
}


void SubdivisionDialog::PrepareDialog()
{
...
void SubdivisionDialog::CreateList(DzNode* Node)
{
...
void SubdivisionDialog::HandleSubdivisionLevelChanged(const QString& text)
{
...
DzNode* SubdivisionDialog::FindObject(DzNode* Node, QString Name)
{
	DzObject* Object = Node->getObject();
	if (Object)
	{
...
void SubdivisionDialog::LockSubdivisionProperties(bool subdivisionEnabled)
{
	DzNode* Selection = dzScene->getPrimarySelection();
	foreach(QComboBox* combo, SubdivisionCombos)
	{
...
void SubdivisionDialog::WriteSubdivisionFile(QString path)
{
	DzNode* Selection = dzScene->getPrimarySelection();
